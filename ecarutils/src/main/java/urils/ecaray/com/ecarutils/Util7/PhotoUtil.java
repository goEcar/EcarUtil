...
public class PhotoUtil {
	...
	public static String saveImagePath(Bitmap bm){
		...
		FileOutputStream fileOutputStream = null;
		File file = new File("/sdcard/xiayizhan/loads/");
		if (!file.exists()) {
			file.mkdirs();
		}
		String fileName = UUID.randomUUID().toString() + ".jpg";
		String filePath = "/sdcard/xiayizhan/loads/" + fileName;
		File f = new File(filePath);
		if (!f.exists()) {
			try {
				f.createNewFile();
	...
	public static String saveToLocal(Bitmap bm) {
		...
		FileOutputStream fileOutputStream = null;
		File file = new File("/sdcard/xiayizhan/Images/");
		if (!file.exists()) {
			file.mkdirs();
		}
		String fileName = UUID.randomUUID().toString() + ".jpg";
		String filePath = "/sdcard/xiayizhan/Images/" + fileName;
		File f = new File(filePath);
		if (!f.exists()) {
			try {
				f.createNewFile();
	...
	public static File createFileFromBitmap(Bitmap bmp ,String name ){
		...
		String filePath = Environment.getExternalStorageDirectory()+"/yitingche/Camera/" + fileName;
		File f = new File(filePath);
	 ...
	 * @return file对象
	 */
	public static File createFileFromBitmap(Bitmap bmp ,String name,int quality){
		String fileName = name + ".jpg";
		String filePath = Environment.getExternalStorageDirectory()+"/yitingche/Camera/" + fileName;
		File f = new File(filePath);
		FileOutputStream fileOutputStream;
	 ...
	 * @return file 对象
	 */
	public static File getFileFromBitmap(Bitmap bmp,String filePath ){
