...
public class CapturePhotoHelper {
    ...
    public final static int SELECT_CAMERA = 100;
    ...
    public void capture() {
        if (hasCamera()) {
            ...
            mActivity.startActivityForResult(captureIntent, SELECT_CAMERA);
    ...
    private void createPhotoFile() {
        if (mPhotoFolder != null) {
            ...
            mPhotoFile = new File(mPhotoFolder, fileName + CameraBitmapUtils.JPG_SUFFIX);
